  ...
  return (
    <>
      ...
      <div className=' lg:mt-16 p-2 '>
        <div className='md:flex  justify-center mb-8 mx-2'>
          <div className='w-full '>
            <div className='bg-blue-900 md:w-60 w-full sm:w-full h-40 md:h-60 text-center mt-16  rounded-tr-3xl  rounded-bl-3xl'>
            ...
            <div className='text-center'>
              <img src="https://images.pexels.com/photos/5589376/pexels-photo-5589376.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt=""
                className='rounded-tl-3xl rounded-br-3xl w-full sm:w-full h-96 sm:h-72' />
            </div>
          </div>
          <div className=''>
            <div>
              <img src="https://images.pexels.com/photos/3122801/pexels-photo-3122801.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt=""
                className='md:h-72 md:w-64 w-full h-72 rounded-tl-3xl rounded-br-3xl'
              />
            </div>
            <div className='bg-blue-900 sm:w-full sm:h-60 h-40 w-full text-center    rounded-tr-3xl  rounded-bl-3xl'>
          ...
          <div>
            <div className='lg:mt-8 mb-16'>
              ...
              />
              <div className='bg-blue-900 sm:w-full sm:h-64 w-full h-60 text-center    rounded-tr-3xl  rounded-bl-3xl'>
      ...
      {/* hdeid */}
      <div className=" flex justify-center h-screen">
        <div className=" grid sm:grid-cols-2 grid-cols-1 lg:mt-20 mt-4  lg:w-[90%]  mb-8 shadow-2xl  rounded-tl-3xl  rounded-r-3xl ">
